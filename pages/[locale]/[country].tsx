    ...
    <div className='flex flex-col items-center justify-center min-h-screen py-2 bg-gray-50'>
      ...
      <main className='flex flex-col items-center flex-1 px-4 sm:px-20 text-center z-10 pt-8 sm:pt-20'>
        <header className='mb-12 flex flex-col items-center justify-center'>
          ...
          <ul className='text-black mb-10'>
            <li>
              Here&apos;s a{" "}
              <button
                className='inline-block border-2 p-2 bg-white'
                onClick={() => {
                  router.push({
                    query: {
                      foo: "bar",
              ...
              that changes the <code>query</code> params with{" "}
            ...
            <li>
              ...
              >
                <a className='text-underline font-mono'>&lt;Link /&gt;</a>
              </Link>{" "}
              that changes the <code>query</code> params
            </li>
          </ul>
